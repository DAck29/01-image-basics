...
def register_images(img, label_img, atlas_img):
    ...
    registered_img = sitk.Resample(img, referenceImage=atlas_img, transform=transform, interpolator=sitkLinear, defaultPixelValue=0.0, outputPixelType=img.GetPixelIDValue())   # todo: modify here
    ...
    registered_label = sitk.Resample(label_img, referenceImage=atlas_img, transform=transform, interpolator=sitkNearestNeighbor, defaultPixelValue=0.0, outputPixelType=label_img.GetPixelIDValue())  # todo: modify here
